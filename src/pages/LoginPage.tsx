      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <img
            ...
            alt="IBL Energy"
            style={{ height: '80px', width: 'auto', objectFit: 'contain', margin: '0 auto 1rem' }}
          />
          <h1 className="text-2xl font-extrabold text-white tracking-tight">Pioneer Tracker</h1>
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-5">
            ...
            {error && (
              <p className="text-sm font-medium rounded-xl p-3 text-center"
