...
export const DEFAULT_USERS: AppUser[] = [
  // Admins (coaches)
  { email: 'delphine.laguette@ibl-energy.com', password: 'IEL2025!',     role: 'admin',  name: 'Delphine Laguette' },
  { email: 'louise@ibl-energy.com',             password: 'IEL2025!',     role: 'admin',  name: 'Louise' },
